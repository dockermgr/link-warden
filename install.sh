...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/link-warden"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="link-warden"
INSTDIR="$HOME/.local/share/dockermgr/link-warden"
APPDIR="$HOME/.local/share/srv/docker/link-warden"
DATADIR="$HOME/.local/share/srv/docker/link-warden/files"
